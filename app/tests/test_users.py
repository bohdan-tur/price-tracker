...
from app.backend.dependencies import get_current_user, get_current_superuser
...
async def test_change_password_success(async_client: AsyncClient, create_test_user,db_session):
...
async def test_delete_my_account(async_client: AsyncClient, create_test_user,db_session):
...
async def test_update_user_status_by_admin(async_client: AsyncClient, create_test_user,db_session):
...
async def test_admin_cannot_disable_another_admin(async_client: AsyncClient, create_test_user):
...
async def test_hard_delete_user_by_admin(async_client: AsyncClient,create_test_user,db_session):
